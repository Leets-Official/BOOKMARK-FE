...
import type { CategoryProps, ICategoryWithTags } from '@/types/api/categoryAndTag';
...
// 카테고리 + 태그 목록 조회
const getCategoriesWithTag = async (): Promise<ApiResponse<ICategoryWithTags[]>> => {
  return apiRequest<ICategoryWithTags[]>({
    method: 'GET',
